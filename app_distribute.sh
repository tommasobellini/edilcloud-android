...
firebase appdistribution:distribute app/build/outputs/apk/debug/app-deb
ug.apk --app 1:1081576602759:android:b9fff8e8b1c67fe6d8cc22 --groups "admin" --release-notes "fixed plans page"  # --testers "bellinitom97@gmail.com"