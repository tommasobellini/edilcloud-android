package com.monkeybits.edilcloud.photoediter;
...
import com.monkeybits.edilcloud.photoediter.base.BaseActivity;
import com.monkeybits.edilcloud.photoediter.filters.FilterListener;
import com.monkeybits.edilcloud.photoediter.filters.FilterViewAdapter;
import com.monkeybits.edilcloud.photoediter.tools.EditingToolsAdapter;
import com.monkeybits.edilcloud.photoediter.tools.ToolType;
...
import static com.monkeybits.edilcloud.photoediter.FileSaveHelper.isSdkHigherThan28;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    private void handleIntentImage(ImageView source) {
        ...
        if (intent != null) {
            try {
                mSaveImageUri = intent.getData();
                Bitmap bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), mSaveImageUri);
